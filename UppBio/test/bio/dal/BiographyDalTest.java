...
public class BiographyDalTest {
    ...
    public void testInsertUpdateDeleteById() {
        ...
        /**
         * Тест Insert в таблицу biography
         */
        ...
        // Переменная INSERT показывает количество добавленных строк в таблицу biography
        ...
        /**
         * Тест Update в таблицу biography
         */
        ...
        // Переменная UPDATE показывает количество обновленных строк в таблице biography
        // dal.update(x) обновляет данные в таблице biography объектом x с id = x.getID()
        int UPDATE = dal.update(biography);
        //Проверка на DUPDATE == 1
        assertTrue(UPDATE == 1);

        /**
         * Тест DeleteById в таблице biography
         */
        // Переменная DELETE показывает количество удаленных строк в таблице biography(в данном случае либо 0, либо 1)
        // dal.deleteById(x) удаляет из таблицы biography запись с id = x
        int DELETE = dal.deleteById(11);
        //Проверка на DELETE == 1
        assertTrue(DELETE == 1);
    }

    /* Возвращает автоинкремент id в таблице biography к 10:
